  ...
  return (
    <div className="py-12">
      <Container className="text-center">
        <h2 className="text-4xl font-bold mb-8 max-md:text-3xl">
          What We Offer
        </h2>
        <div className="grid grid-cols-3 gap-4 max-md:grid-cols-1 max-md:gap-8">
          ...
          <div>
            ...
            <p>
              Always be in the know with our accurate exchange rate and currency
              tracking
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              we provide a user friendly application that is very easy to
              navigate.
            </p>
          </div>
        </div>
